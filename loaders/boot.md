...
- `{MODE}`: one of `modes/prime.md` (human-driven), `modes/avatar.md` (dispatched worker), `modes/moot.md` (shared-context, multiple members).
...
> Precedence on conflict: constraints > member identity > mode > core baseline.
